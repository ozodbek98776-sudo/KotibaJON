        ...
        <div className="relative max-w-7xl mx-auto px-5">
          <div className="flex flex-col lg:flex-row items-center gap-16 pt-16 pb-20 lg:pt-24 lg:pb-32">
            ...
            <div className="hidden lg:flex flex-1 items-center justify-center relative">
              ...
              {[
                { pos:'-left-6 top-[18%]',    icon:<Users className="w-3.5 h-3.5 text-emerald-500"/>, label:'50,000+ foydalanuvchi' },
                { pos:'-right-6 bottom-[20%]', icon:<Globe className="w-3.5 h-3.5 text-blue-500"/>,    label:"O'zbek tiliga mos" },
                { pos:'left-[12%] -bottom-4',  icon:<Zap   className="w-3.5 h-3.5 text-amber-500"/>,  label:'Offline rejim' },
              ].map(({ pos, icon, label }) => (
                <div key={label} className={`absolute ${pos} bg-white rounded-xl px-3.5 py-2.5 border border-slate-200 text-xs font-bold text-slate-700 flex items-center gap-2`}
              ...
              <div key={p.name}
                ...
                {p.badge && (
                  <div className="absolute -top-3.5 inset-x-0 flex justify-center">
                    <span className="bg-blue-600 text-white text-[11px] font-black px-4 py-1 rounded-full inline-flex items-center gap-1">
                      <Star className="w-3 h-3 fill-white text-white" />{p.badge}
                    </span>
                  </div>
                )}
                <div className="mb-5">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="rounded-3xl p-14 text-center relative overflow-hidden"
            ...
            <div className="relative z-10">
              ...
              <div className="mt-5 flex flex-wrap items-center justify-center gap-3 text-xs text-slate-500 font-medium">
                <span className="flex items-center gap-1"><Check className="w-3 h-3 text-emerald-400 flex-shrink-0"/>Kredit karta yo'q</span>
                <span className="text-slate-300">·</span>
                <span className="flex items-center gap-1"><Check className="w-3 h-3 text-emerald-400 flex-shrink-0"/>Istalgan vaqt bekor qilish</span>
                <span className="text-slate-300">·</span>
                <span className="flex items-center gap-1"><Check className="w-3 h-3 text-emerald-400 flex-shrink-0"/>Bepul boshlash</span>
              </div>
            </div>
          </div>
        </div>
